...
# Module Pipeline Probe Startup Script
# Port: 39140 (Module Pipeline Probe Service)
# This script helps start the module pipeline probe service in development mode
...
SERVICE_NAME="Module Pipeline Probe"
SERVICE_PORT="39140"
...
set_registration_host "module-pipeline-probe" "MODULE_PIPELINE_PROBE_HOST"

# Set additional environment variables if needed
# (Module pipeline probe uses shared infrastructure, so minimal additional config)
...
echo "  Service Host: $MODULE_PIPELINE_PROBE_HOST"
...
./gradlew quarkusDev -Dmodule.registration.host=$MODULE_PIPELINE_PROBE_HOST