...
public class TestProcessorHelper {
    ...
    public static class TestDocumentBuilder {
        ...
        public PipeDoc build() {
            ...
            SearchMetadata.Builder searchMetadata = SearchMetadata.newBuilder().setDocumentType("test");
            if (title != null) {
            ...
            if (customStruct.getFieldsCount() > 0) {
                searchMetadata.setCustomFields(customStruct);
            }

            builder.setSearchMetadata(searchMetadata);
